...
class MockCalculator:
    ...
    _mask_sequence = NERInterAnnotatorAgreement._mask_sequence
...
class TestMetricsCalculator:
    ...
    def test_filter_non_o_labels(self, seq1, seq2, expected1, expected2):
        ...
        res1, res2 = NERInterAnnotatorAgreement._filter_non_o_labels(seq1, seq2)
    ...
    def test_filter_non_o_labels_length_mismatch(self):
        ...
        with pytest.raises(ValueError, match="Sequences have different lengths"):
            NERInterAnnotatorAgreement._filter_non_o_labels(seq1, seq2)
    ...
    def test_report_metrics_real_example_without_o(self):
        metrics_without_o = NERInterAnnotatorAgreement(should_ignore_o_labels=True)
    ...
    def test_report_metrics_real_example_with_o(self):
        metrics_with_o = NERInterAnnotatorAgreement(should_ignore_o_labels=False)
